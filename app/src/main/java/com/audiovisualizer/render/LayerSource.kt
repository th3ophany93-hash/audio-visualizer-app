...
sealed class LayerSource {
    data class Image(val uri: Uri, val transform: ImageTransform = ImageTransform()) : LayerSource()
    data class Video(val uri: Uri, val transform: ImageTransform = ImageTransform()) : LayerSource()
